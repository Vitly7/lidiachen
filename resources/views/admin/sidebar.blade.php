<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ url('/showcollection') }}">
          <span class="menu-icon">
            <i class="mdi mdi-file-document-box"></i>
          </span>
          <span class="menu-title">Show Collection</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ url('/showcontactus') }}">
          <span class="menu-icon">
            <i class="mdi mdi-file-document-box"></i>
          </span>
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ url('/showuser') }}">
          ...
          <span class="menu-title">Show User & Admin</span>
        </a>
      </li>
    </ul>
  </nav>